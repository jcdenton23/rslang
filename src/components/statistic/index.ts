  ...
  <div class="container">
    <div class="statistics__content">
      <div class="statistics__games">
        <h3 class="title__section-subtitle">Today</h3>
        <div class="statistics__wrapper d-flex flex-column align-items-center gap-3">
          ...
          <div class="card w-100 shadow-lg p-3">
            ...
            <div class="progress">
              <div class="progress-bar progress-bar-striped progress-bar-animated ${BackgroundBootstrap.success}"
                role="progressbar" title="Correct Answers" style="width: ${percentCorrectWordsPerDay}%">
                ${percentCorrectWordsPerDay}%
              </div>
              <div class="progress-bar progress-bar-striped progress-bar-animated  ${BackgroundBootstrap.danger}"
                role="progressbar" title="Wrong Answers" style="width: ${100 - percentCorrectWordsPerDay}%">
          ...
          <div class="card w-100 shadow-lg p-3">
            ...
            <div class="progress">
              <div class="progress-bar progress-bar-striped progress-bar-animated ${BackgroundBootstrap.success}"
                role="progressbar" title="Correct Answers" style="width: ${percentCorrectWordsSprint}%">
                ${percentCorrectWordsSprint}%
              </div>
              <div class="progress-bar progress-bar-striped progress-bar-animated  ${BackgroundBootstrap.danger}"
                role="progressbar" title="Wrong Answers" style="width: ${100 - percentCorrectWordsSprint}%">
          ...
          <div class="card w-100 shadow-lg p-3 ">
            ...
            <div class="progress">
              <div class="progress-bar progress-bar-striped progress-bar-animated ${BackgroundBootstrap.success}"
                role="progressbar" title="Correct Answers" style="width: ${percentCorrectWordsAudioChallenge}%">
                ${percentCorrectWordsAudioChallenge}%
              </div>
              <div class="progress-bar progress-bar-striped progress-bar-animated  ${BackgroundBootstrap.danger}"
                role="progressbar" title="Wrong Answers" style="width: ${100 - percentCorrectWordsAudioChallenge}%">
